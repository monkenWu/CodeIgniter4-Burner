...
$server->on("request", function (Request $swooleRequest, Response $swooleResponse) use ($uriFactory, $streamFactory, $uploadedFileFactory, $responseMerger) {

    if(is_null($swooleRequest->files)) $swooleRequest->files = [];
